         ...
         if($this->session->userdata('email')==null)
          {
          	redirect('Welcome');
                ...
                //print_r($getprofileId);

              foreach ($getprofileId as  $row) {
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Change User Profile</h2>
							</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-title">Update Our Details</div>
								</div>
	  <?php if($responce1 = $this->session->flashdata('true')): ?>
        <div class="col-lg-6">
        <div class="alert alert-success"><?php echo $responce1;?></div>
      </div>
    <?php endif;?>
								<div class="card-body">
									<div class="row">
									<form id="myform" enctype="multipart/form-data" action="<?php echo base_url(); ?>Welcome/updateuser" method="post"> 
										<div class="col-md-8 col-lg-8">
											<div class="form-group">
												<label for="email2">Enter Name</label>
												<input type="text" class="form-control" value="<?php echo $row->username?>" name="username" id="email2" placeholder="Enter Title">
											</div>
                                    

	                                       <div class="form-group">
												<label for="email2">Enter Email</label>
												<input type="text" class="form-control" value="<?php echo $row->email?>" name="email" id="email2" placeholder="Enter Title" readonly>
											</div>

									<div class="form-group">
										<label for="email2">Enter Mobile</label>
										<input type="text" class="form-control" name="phone" value="<?php echo $row->phone?>" id="email2" placeholder="Enter Title">
									</div>
...
<!-- Mirrored from demo.themekita.com/atlantis/livepreview/examples/demo1/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Jul 2020 07:22:34 GMT -->
</html>
<?php } }?>