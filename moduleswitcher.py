...
def shifter(voice_in):
    ...
    calculator_list=["calculator","open calculator","open the calculator for me","open the calculator"]
    ...
    #     #generalq.enter
        ...
        return check
    elif voice_in.lower() in reminder_list:
        # eng.say("Switching to Jokes Module")
        # eng.runAndWait()
        ...
        print("Xceleron: This functionality will be available soon!")
